                ...
                <div class="col-md-6 main_left">
                    <div class="container-fluid">
                        <div class="main_content">
                            ...
                            <button>
                                <a href="<?php echo e(route('bookings.create')); ?>">Записаться</a>
                            </button>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\test\resources\views/home.blade.php ENDPATH**/ ?>